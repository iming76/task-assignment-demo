...
For each task, first identify the categoryName its work belongs to (e.g. Frontend, Backend, Database, DevOps & Cloud, Testing & QA, Mobile, AI & Machine Learning, Security, UI/UX, Architecture, Data Engineering), then only search for matching skills within that category's skills.
